    ...
    {/* 1. Hero Section */}
      ...
      <div className="w-full max-w-7xl px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20">
        <h1 className="text-[22px] sm:text-[28px] md:text-[32px] lg:text-[36px] font-bold text-center mb-3 sm:mb-4 text-[#FFFFFF]">
          AI Operating System · Memory · Orchestration
        </h1>
        ...
        FloBrain helps  teams build AI-enabled apps and devices with persistent memory,
  workflow orchestration, model routing, and real-time coordination across web,
  mobile, robotics, IoT, and enterprise systems.
        </p>
