    ...
    return (
        <div className="w-full px-8  my-[150px]">
            <div className="bg-[#ECB4FF] py-[50px] rounded-[16px] flex flex-col items-center">
                ...
                <p className="mt-10 w-[55%] text-center text-black">Whether you&apos;re using a wearable AI assistant, a productivity app, or an autonomous robot, FloBrain provides the intelligence layer you need.</p>
