export default function DashboardSkeleton() {
  return (
    <div className="animate-pulse">
      {/* Header Skeleton */}
      <div className="mb-8">
        <div className="h-10 bg-white/10 rounded w-80 mb-2"></div>
      ...
      <div className="flex gap-6 mb-6">
        ...
        >
          ...
          <div 
            ...
            style={{ background: '#F3CEFF85' }}
          >
            <div className="h-4 bg-white/30 rounded w-32 mb-2"></div>
            <div className="flex items-center gap-2">
              <div className="h-10 bg-white/30 rounded w-48"></div>
        ...
        >
          ...
          <div 
            ...
            style={{ background: '#F3CEFF85', height: '108px' }}
          >
          ...
          <div>
            ...
            <div className="rounded-lg p-4">
              <div className="flex flex-col gap-1.5">
                {Array.from({ length: 7 }).map((_, rowIndex) => (
                  <div key={rowIndex} className="flex items-center">
                    <div className="h-4 bg-white/20 rounded w-8 mr-2"></div>
              ...
              <div className="flex justify-between text-xs mt-3" style={{ marginLeft: '35px' }}>
                <div className="h-3 bg-white/20 rounded w-10"></div>
                <div className="h-3 bg-white/20 rounded w-10"></div>
                <div className="h-3 bg-white/20 rounded w-10"></div>
                <div className="h-3 bg-white/20 rounded w-10"></div>
                <div className="h-3 bg-white/20 rounded w-10"></div>
        ...
        <div className="mb-3">
          ...
          >
            <div className="flex items-start gap-3">
              <div className="w-5 h-5 bg-white/30 rounded-full mt-1"></div>
              <div className="flex-1">
                <div className="h-4 bg-white/30 rounded w-40 mb-3"></div>
