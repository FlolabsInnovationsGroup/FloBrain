          ...
          {!isLoading && isAuthenticated ? (
            <div className="flex items-center gap-1">
              ...
              <Link
                ...
                className="flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-zinc-400 hover:text-white"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className={navIconClass} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <div className="mx-auto mt-2 max-w-6xl rounded-2xl border border-white/5 bg-[#0f0a1a]/95 p-4 shadow-lg md:hidden">
          {!isLoading && isAuthenticated ? (
            <div className="flex flex-col gap-2">
              ...
              <Link href="/models" className="rounded-lg py-2 text-zinc-300" onClick={() => setIsOpen(false)}>Models</Link>
